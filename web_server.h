...
private:
    ...
    bool deal_with_signal(bool& timeout, bool& stop_server); // 信号事件，超时删除功能
    void deal_with_read(int sockfd); // 读事件
    void deal_with_write(int sockfd); // 写事件
