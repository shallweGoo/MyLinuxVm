...
static const std::string error_400_form = "Your request has bad syntax or is inherently impossible to stasify.\n";
...
private:
    ...
    bool add_302headers();
    bool add_cookie(const char* key, const char* value);
